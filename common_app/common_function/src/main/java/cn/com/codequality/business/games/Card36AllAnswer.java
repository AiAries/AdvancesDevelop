...
public class Card36AllAnswer {
	...
	public static List<String> express =new ArrayList<>();
	 ...
	 * @return
	 */
	public static void calc(float[] tempGroup, int[] signs) {
	...
	public static void calc2(float[] tempGroup, int[] signs) {
	...
	public static void getCard36ByInputNum(float[] cards,boolean isContainBracket){
		// 36 + - * /
						...
						for (int i3 = 0; i3 < 4; i3++) {
							...
							for (int j3 = 0; j3 < 4; j3++) {
								...
								for (int k3 = 0; k3 < 4; k3++) {
									signs[2] = k3;
									if (isContainBracket) {
										calc(tempGroup,signs);
									}else {
										calc2(tempGroup,signs);
									}
								}
							}
						}
