...
public class MainPageActivity extends ShadeBaseActivity {
     ...
     * get tab'info
     *
     * @param useLocalSignature whether use cache signature
     */
    public void getTabInfo(final boolean useLocalSignature) {
        Map<String, Object> params = getParams(useLocalSignature);
    ...
    */
     ...
     * @return
     */
    private Map<String, Object> getParams(boolean useLocalSignature) {
...
//        }
        params.put("tabId", "");
        params.put("version", AndroidUtil.getAppVersion(this));
